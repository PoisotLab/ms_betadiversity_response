...
p1 = heatmap(Co2, p', OS', aspectratio=1, fill=true, lc=:white, clim=(0,1))
vline!([Co1], c=:black, lab="", lw=3, ls=:dash)
xaxis!(p1, "Connectance of N₂", (0, 1))
yaxis!(p1, "Species sharing probability", (0, 1))
title!(p1, "βos")

p2 = heatmap(Co2, p', ST', aspectratio=1, fill=true, lc=:white, clim=(0,1))
vline!([Co1], c=:black, lab="", lw=3, ls=:dash)
xaxis!(p2, "Connectance of N₂", (0, 1))
yaxis!(p2, "Species sharing probability", (0, 1))
title!(p2, "βst")

p3 = heatmap(Co2, p', WN', aspectratio=1, fill=true, lc=:white, clim=(0,1))
vline!([Co1], c=:black, lab="", lw=3, ls=:dash)
xaxis!(p3, "Connectance of N₂", (0, 1))
yaxis!(p3, "Species sharing probability", (0, 1))
title!(p3, "βwn")

p4 = heatmap(Co2, p', (ST./WN)', aspectratio=1, fill=true, lc=:white, clim=(0,1))
vline!([Co1], c=:black, lab="", lw=3, ls=:dash)
